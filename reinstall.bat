...
set confhome=https://raw.githubusercontent.com/elesssss/reinstall/main
set confhome_cn=https://cnb.cool/bin456789/reinstall/-/git/raw/main
rem set confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/elesssss/reinstall/main
